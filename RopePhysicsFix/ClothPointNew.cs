...
namespace RopePhysicsFix
{
    public class ClothPointNew
    {
        ...
        public ClothPointNew(ClothSystem cs)
        {
            this.cs = cs;
            Pos = new Vec3d();
            init();
        ...
        protected ClothPointNew()
        {
        }

        public ClothPointNew(ClothSystem cs, int pointIndex, double x, double y, double z)
        {
            this.cs = cs;
        ...
        public ClothPointNew(ClothSystem cs, Vec3d pos, Entity attachedEntity) : this(cs)
        {
            Pos = pos;
        ...
        public void updateFromPoint(ClothPointNew point, IWorldAccessor world)
        {
        ...
        public void updateFromPoint(ClothPoint originalPoint, IWorldAccessor world)
        {
            ...
            GravityStrength = (float)typeof(ClothPoint).GetField("GravityStrength", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(originalPoint);
            pinned = (bool)typeof(ClothPoint).GetField("pinned", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(originalPoint);
            pinnedToPlayerUid = (string)typeof(ClothPoint).GetField("pinnedToPlayerUid", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(originalPoint);
            pinnedToOffsetStartYaw = (float)typeof(ClothPoint).GetField("pinnedToOffsetStartYaw", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)?.GetValue(originalPoint);
